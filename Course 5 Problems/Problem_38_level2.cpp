...
void CopyArrayOnlyPrime(int arr[100], int arr2[100], int length, int& copyLength)
{
    for (int i = 0;i < length; i++)
    {
        if(CheckNumberPrimeNotPrime(arr[i]) == enPrimeNotPrime::Prime)
...
int main() {
    ...
    CopyArrayOnlyPrime(arr, arrCopy, length, copyLength);
